...
class Wallet:
    ...
    def sign_transaction(self, sender, recipient, amount):
        ...
        hashed = SHA256.new((str(sender) + str(recipient) + str(amount)).encode('utf8'))
    ...
    def verify_transaction(transaction):
        ...
        hashed = SHA256.new((str(transaction.sender) + str(transaction.recipient) + str(transaction.amount)).encode('utf8'))
